...
int Sdb_adaptor::get_sdb_cl(my_thread_id tid, char *cs_name, char *cl_name,
                            Sdb_cl_auto_ptr &collection, bool create) {
  int rc = SDB_ERR_OK;
...
int Sdb_adaptor::create_sdb_cl(my_thread_id tid, char *cs_name, char *cl_name,
